...
public class JwtUtil {
    private final String SECRET_KEY = "your_secret_key_that_is_super_secret_and_long_enough_for_jwt_signing"; // Replace with your actual secret key
